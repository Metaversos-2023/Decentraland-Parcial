...
export function main() {
  ...
  Transform.create(leftCollider, {
    ...
    scale: Vector3.create(1.5, 7, 0.5)
  })
  ...
  const altairScale = Vector3.create(0.8, 1.5, 0.8)
  ...
  pointerEventsSystem.onPointerDown(
    {
      entity: fountain,
      opts: { button: InputAction.IA_PRIMARY, hoverText: 'Reveal hint', maxDistance: 8 }
    },
    function () {
  ...
  pointerEventsSystem.onPointerDown(
    ...
    function () {
      ...
      const newCloudPosition = Vector3.create(
        currentCloudPosition.x,
        currentCloudPosition.y + 1,
        currentCloudPosition.z - 1
      )
      ...
      const newColliderPosition = Vector3.create(
        currentColliderPosition.x,
        currentColliderPosition.y + 1,
        currentColliderPosition.z - 1
      )
  ...
  pointerEventsSystem.onPointerDown(
    ...
    function () {
      ...
      d.text = `Find the \ncrusifixes to \nend this.\n ${amount}/5 Found`
      task = `Find the Crusifixes. (${amount}/5)`
      setupUi(task, 0)
      const v = TextShape.getMutable(sign)
      v.text = ''
      const c = TextShape.getMutable(hint)
  ...
  pointerEventsSystem.onPointerDown(
    {
      ...
      opts: { button: InputAction.IA_PRIMARY, hoverText: 'Grab', maxDistance: 8 }
    },
    function () {
      ...
      if (amount == 5) {
        ...
        task = 'Well done, now exorcise it.'
        setupUi(task, 0)
...
function PutChurch() {
  ...
  Transform.create(west, {
    ...
    scale: Vector3.create(0.3, 19.5, 29.6)
  })
  ...
  Transform.create(north, {
    ...
    scale: Vector3.create(22, 12, 0.5)
  })
  ...
  Transform.create(westRoof, {
    ...
    scale: Vector3.create(0.3, 12, 29.6),
